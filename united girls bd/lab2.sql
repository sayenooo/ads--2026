...
UPDATE MEMBER SET age = 17 WHERE memberID = 1;
UPDATE MEMBER SET age = 18 WHERE memberID = 2;
UPDATE MEMBER SET age = 19 WHERE memberID = 3;
UPDATE MEMBER SET age = 20 WHERE memberID = 4;
UPDATE MEMBER SET age = 17 WHERE memberID = 5;
UPDATE MEMBER SET age = 18 WHERE memberID = 6;
UPDATE MEMBER SET age = 19 WHERE memberID = 7;
UPDATE MEMBER SET age = 20 WHERE memberID = 8;
UPDATE MEMBER SET age = 17 WHERE memberID = 9;
UPDATE MEMBER SET age = 18 WHERE memberID = 10;
UPDATE MEMBER SET age = 19 WHERE memberID = 11;
UPDATE MEMBER SET age = 20 WHERE memberID = 12;
